...
<form method="post" action=" {{asset ('contact/'.$user->id)}} " style="
    width: 1000px;
    height: 500px;
    margin-top: 70px;
    margin-left: 280px;">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="integer" value="{{$user->phone}}" class="form-control" id="phone" name="phone"
                placeholder="phone">
        </div>
    </div>
            ...
            <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label>
                            <input type="radio" value="{{$user->gendar}}" name="gendar" />
                            Male
                        </label>
                        <label>
                            <input type="radio" value="{{$user->gendar}}" name="gendar" />
